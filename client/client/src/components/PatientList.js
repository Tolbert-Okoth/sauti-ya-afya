...
const PatientList = () => {
  ...
  if (loading) return <div className="p-5 text-center text-muted animate-pulse">Loading patient records...</div>;
    ...
    <div className="container-fluid p-0">
      ...
      <div className="row g-3 mb-4">
        <div className="col-12 col-md-8">
          <div className="input-group shadow-sm">
            <span className="input-group-text border-0 bg-white"><FaSearch className="text-muted"/></span>
            <input 
              type="text" 
        ...
        <div className="col-12 col-md-4">
          <div className="input-group shadow-sm">
             <span className="input-group-text border-0 bg-white"><FaFilter className="text-muted"/></span>
             <select 
        ...
        {filteredPatients.length > 0 ? (
          filteredPatients.map((p) => (
            <div key={p.id} className="col-12 mb-3">
              ...
              >
                <div className="d-flex align-items-center">
                  <div className="me-3">
                    <div className="bg-light rounded-circle p-3 text-accent d-flex align-items-center justify-content-center" style={{width: '50px', height: '50px'}}>
            ...
            <div className="col-12 text-center py-5 text-muted glass-card">
                <p className="mb-0">No patients found matching "{searchTerm}"</p>
            </div>
        )}
      </div>
      ...
      {selectedPatient && (
        <div style={{
           ...
           <div className="bg-white rounded-4 shadow-lg overflow-hidden animate-slide-in" style={{width: '90%', maxWidth: '800px', maxHeight: '90vh', overflowY: 'auto'}}>
               
               {/* Modal Header */}
               <div className="p-3 border-bottom d-flex justify-content-between align-items-center bg-light">
                   <h5 className="mb-0 fw-bold text-dark-brown"><FaStethoscope className="me-2"/>Clinical Review</h5>
               ...
               <div className="p-4">
                   <div className="row">
                       ...
                       <div className="col-md-6 border-end">
                           <h2 className="fw-bold mb-0 text-dark-brown">{selectedPatient.name}</h2>
                           <p className="text-muted mb-4">{selectedPatient.age} • {selectedPatient.location}</p>
                           
                           <div className="mb-4">
                               <label className="small fw-bold text-muted text-uppercase mb-1">AI Diagnosis</label>
                               <div className="d-flex align-items-center">
                                   <h3 className="fw-bold me-3 mb-0 text-dark-brown">{selectedPatient.diagnosis}</h3>
                           ...
                           <div className="mb-3">
                               ...
                               <div className="p-2 bg-light rounded fst-italic text-dark">"{selectedPatient.symptoms}"</div>
                           </div>
                       </div>
                       ...
                       <div className="col-md-6 ps-md-4">
                           <div className="mb-3">
                               <label className="small fw-bold text-muted text-uppercase mb-1"><FaNotesMedical className="me-1"/> Interpretation</label>
                           ...
                           <div className="mb-3">
                               ...
                               {selectedPatient.recording_url ? (
                                   <div className="p-3 bg-light rounded-3 text-center">
                                       {audioLoading && <div className="text-primary small fw-bold"><FaSpinner className="spin me-2"/>Loading...</div>}
                                       ...
                                       <div className="mt-2 pt-2 border-top">
                                            <a href={selectedPatient.recording_url.startsWith('http') ? selectedPatient.recording_url : `${config.SERVER_URL}/uploads/${selectedPatient.recording_url}`} 
                                               target="_blank" rel="noopener noreferrer" className="small text-muted text-decoration-underline">
                                                (Download Original)
                                            </a>
                                       </div>
                                   </div>
